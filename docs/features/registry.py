...
"Runtime and DINOv2/UPerNet architecture are implemented, and TWO heads have now "
      ...
      "The limit is the corpus, not the loss: SpaceNet 7 is 0.5 m satellite imagery "
      "labelled for one class, and OpenEarthMap is the only source carrying all six. "
      "Another weight sweep moves this a few points; what it needs is fully labelled "
      "imagery at drone resolution. Evidence: docs/holdout/shared_semantic_india_holdout.json "
      "(v1) and docs/holdout/shared_semantic_v2_india_holdout.json (v2)."),
