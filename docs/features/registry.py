...
"Runtime and DINOv2/UPerNet architecture are implemented, and TWO heads have now "
      ...
      "since averaging class 1 with class 3 would invent class 2. NOT YET RETRAINED: the "
      "fix is tested, the claim stays where it is until a run measures it. "
      "Evidence: docs/holdout/shared_semantic_india_holdout.json (v1), "
      "docs/holdout/shared_semantic_v2_india_holdout.json (v2), "
      "tests/test_semantic_scale.py (the measurement)."),
