...
MISSION_PLANNING = [
    ...
    F("mp.type.multi_facade", "Multi-facade missions", "core", "Mission types",
      "One mission covering several building faces, each with independent parameters.",
      "not_started", []),
    ...
    F("mp.type.closed_loop", "Closed-loop structure capture", "core", "Mission types",
      "Continuous loops around a structure, multiple rings and radii, both directions.",
      "not_started", []),
    ...
    F("mp.type.wind_turbine", "Wind turbine inspection", "core", "Mission types",
      "Tower, nacelle and per-blade-section capture at multiple blade positions.",
      "not_started", []),
...
PLATFORM = [
    ...
    F("hub.orgs", "Organizations and roles", "hub", "Hub",
      "Multiple organizations, role-based permissions and member management.",
      "not_started", []),
    F("hub.auth", "Authentication", "hub", "Security",
      "Local auth, MFA, API tokens and session management; OAuth/OIDC optional.",
      "not_started", []),
    ...
    F("rp.formats", "Report formats", "hub", "Reporting",
      "PDF, DOCX, HTML, CSV and JSON output.",
      "in_progress", [], "HTML and Markdown only."),
    F("rp.templates", "Report templates", "hub", "Reporting",
      "Reusable organisation templates with logos and section selection.",
      "not_started", []),
    ...
    F("sec.audit", "Audit log", "hub", "Security",
      "Every critical action recorded with actor and timestamp.",
      "in_progress", [], "core/audit.py exists; coverage incomplete."),
    F("sec.rbac", "Role based access control", "hub", "Security",
      "Permissions enforced on every resource.",
      "not_started", []),
    ...
    F("inf.postgis", "PostgreSQL and PostGIS", "infra", "Deployment",
      "Spatial data in native PostGIS types.",
      "not_started", [], "Currently SQLite."),
