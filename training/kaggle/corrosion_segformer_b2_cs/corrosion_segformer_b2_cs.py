"""Kaggle kernel: train corrosion_segformer_b2_cs (segmentation_multiclass).
...
CORPUS = Path("/kaggle/input/odk-corrosion-seg-corpus")
...
def main() -> int:
    ...
    if "training.train_seg_multiclass" == "training.train_shared_semantic":
        ...
        command = [
            ...
            "--config", str(REPO / "training" / "configs" / "corrosion_segformer_b2_cs.yaml"),
            "--corpus", str(corpus / "corpus.json"),
            "--run-dir", str(OUT / "corrosion_segformer_b2_cs"),
            "--source", "github",
        ]
    else:
        command = [
