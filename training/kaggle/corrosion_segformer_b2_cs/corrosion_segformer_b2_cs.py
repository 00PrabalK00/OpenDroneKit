"""Kaggle kernel: train corrosion_segformer_b2_cs (segmentation).
...
def main() -> int:
    ...
    if 'training.train_seg' == 'training.train_det':
        ensure_ultralytics()
    ensure_repo()
    corpus = resolve_corpus()

    if "training.train_seg" == "training.train_shared_semantic":
        ...
        command = [
            sys.executable, "-m", "training.train_seg",
