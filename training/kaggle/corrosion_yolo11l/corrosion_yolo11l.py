"""Kaggle kernel: train corrosion_yolo11l (detection).
...
CORPUS = Path("/kaggle/input/odk-corrosion-det-corpus")
...
def main() -> int:
    ...
    command = [
        ...
        "--config", str(REPO / "training" / "configs" / "corrosion_yolo11l.yaml"),
