"""Kaggle kernel: train shared_semantic_dinov2_vitb14 (semantic).
...
CORPUS = Path("/kaggle/input/odk-shared-semantic-v4")
...
def main() -> int:
    ...
    if 'training.train_shared_semantic' == 'training.train_det':
        ensure_ultralytics()
    ensure_repo()
    corpus = resolve_corpus()

    if "training.train_shared_semantic" == "training.train_shared_semantic":
...
def restore_checkpoint(corpus: Path) -> bool:
    ...
    """
    target = OUT / "shared_semantic_dinov2_vitb14"
