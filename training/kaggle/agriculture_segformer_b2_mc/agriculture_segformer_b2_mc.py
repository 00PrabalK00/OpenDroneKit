"""Kaggle kernel: train agriculture_segformer_b2_mc (segmentation_multiclass).
...
def main() -> int:
    ...
    if "training.train_seg_multiclass" == "training.train_shared_semantic":
        ...
        command = [
            ...
            "--config", str(REPO / "training" / "configs" / "agriculture_segformer_b2_mc.yaml"),
            "--corpus", str(corpus / "corpus.json"),
            "--run-dir", str(OUT / "agriculture_segformer_b2_mc"),
            "--source", "github",
        ]
    else:
        command = [
